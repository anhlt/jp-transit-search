...
from jp_transit_search.core.models import Route, RouteSearchRequest, Station, Transfer
...
class TestRouteSearchRequest:
    ...
    def test_request_creation(self):
        ...
        request = RouteSearchRequest(from_station="横浜", to_station="豊洲")
    ...
    def test_request_with_datetime_time_extraction(self):
        ...
        request = RouteSearchRequest(
            from_station="横浜", to_station="豊洲", search_datetime=test_datetime
        )
    ...
    def test_request_search_types(self):
        ...
        # Test latest arrival
        request = RouteSearchRequest(
            from_station="横浜", to_station="豊洲", search_type="latest"
        )
        assert request.search_type == "latest"

        # Test cheapest route
        request = RouteSearchRequest(
            from_station="横浜", to_station="豊洲", search_type="cheapest"
        )
