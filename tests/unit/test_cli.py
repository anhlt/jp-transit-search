...
from jp_transit_search.core.exceptions import RouteNotFoundError, ScrapingError, ValidationError
...
class TestCLI:
    ...
    def test_search_command_success_detailed_format(self, mock_scraper_class):
        ...
        result = self.runner.invoke(cli, ['search', '横浜', '豊洲', '--format', 'detailed'])
    ...
    def test_search_command_route_not_found_error(self, mock_scraper_class):
        ...
        result = self.runner.invoke(cli, ['search', 'Invalid', 'Station'], catch_exceptions=False)
    ...
    def test_search_command_scraping_error(self, mock_scraper_class):
        ...
        result = self.runner.invoke(cli, ['search', '横浜', '豊洲'], catch_exceptions=False)
    ...
    def test_search_command_unexpected_error_verbose(self, mock_scraper_class):
        ...
        result = self.runner.invoke(cli, ['search', '横浜', '豊洲', '--verbose'], catch_exceptions=False)
