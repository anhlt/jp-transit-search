...
横浜,神奈川県,横浜市,JR東日本,東海道線,JT05,35.466188,139.622540,よこはま|Yokohama"""
    ...
    def test_search_command_no_data_file(self, runner):
        ...
        result = runner.invoke(stations, ['search', '新宿', '--data', 'nonexistent.csv'])
        assert result.exit_code == 0
    ...
    def test_search_command_success(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['search', '新宿', '--data', str(sample_csv_file)])
    ...
    def test_search_command_with_prefecture(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['search', '宿', '--prefecture', '東京都', '--data', str(sample_csv_file)])
    ...
    def test_search_command_exact_match(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['search', '新宿', '--exact', '--data', str(sample_csv_file)])
    ...
    def test_search_command_no_results(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['search', '存在しない駅', '--data', str(sample_csv_file)])
    ...
    def test_list_command_table_format(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['list', '--data', str(sample_csv_file), '--format', 'table'])
    ...
    def test_list_command_json_format(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['list', '--data', str(sample_csv_file), '--format', 'json'])
    ...
    def test_list_command_csv_format(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['list', '--data', str(sample_csv_file), '--format', 'csv'])
    ...
    def test_list_command_with_prefecture(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['list', '--prefecture', '東京都', '--data', str(sample_csv_file)])
    ...
    def test_list_command_with_limit(self, runner, sample_csv_file):
        ...
        result = runner.invoke(stations, ['list', '--limit', '1', '--data', str(sample_csv_file)])
