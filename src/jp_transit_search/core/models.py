...
class Transfer(BaseModel):
    ...
    departure_time: time | None = Field(None, description="Departure time")
    arrival_time: time | None = Field(None, description="Arrival time")
...
class RouteSearchRequest(BaseModel):
    ...
    search_datetime: datetime | None = Field(
        None, description="Search date and time"
    )
